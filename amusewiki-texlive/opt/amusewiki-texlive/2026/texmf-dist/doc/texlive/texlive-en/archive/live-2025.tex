% $Id: texlive-en.tex 74120 2025-02-18 22:51:42Z karl $
...
\title{%
  {\huge \textit{The \TeX\ Live Guide---2025}}
}
...
\begin{description}
  ...
  \begin{ttdescription}
    \item[2024] A previous release.
    \item[2025] The current release.
    \begin{ttdescription}
      \item [bin] ~
      \begin{ttdescription}
...
\dirname{/usr/local/texlive/2025} on Unix and
|C:\texlive\2025| on Windows.  This arrangement enables
...
create |C:\texlive\2025| (or, more generally,
|%SystemDrive%\texlive\2025|).
...
If you installed \TL\ from \DVD\ or an \ISO\ image and then wish to get
updates from the Internet, you need to run this command---\emph{after}
you've updated your search path (as described in the previous section):
...
\file{.../2025/texmf.cnf}.  If you must make changes to the defaults
(not normally necessary), this is the place to put them.  The main
configuration file is in \file{.../2025/texmf-dist/web2c/texmf.cnf}.
...
\item If \cs{tracinglostchars=4}, warn about missing characters when
  ...
  into an error.
\item New primitive \cs{mathemptydisplaymode}; when set to
...
\begin{quote}
\email{tex-live@tug.org} {\small (you need not subscribe in order to post)}\\
\url{https://tug.org/texlive}
\end{quote}
